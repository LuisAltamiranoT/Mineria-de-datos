...
#access_token = "999027411613356032-NvGF9YveYjVjQq4sf61x5IbFDe0KBej"
#access_token_secret = "ZHTEn2rxBoKLIkFa57Ksm3Hs4jYtwimhgYcsq8TtAXVXv"
...
try:
    ...
    db = server.create('tulcan')
except:
    # Caso contrario solo conectarse a la base existente
    db = server['tulcan']

# Aqui se define el bounding box con los limites geograficos donde recolectar los tweets
twitterStream.filter(track=["alcaldia","candidatos","tulcan"])
